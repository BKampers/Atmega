...
#define ONEWIRE_CRC16 1
    ...
    // Perform a 1-Wire reset cycle. Returns true if a device responds
    // with a presence pulse.  Returns false if there is no device or the
    // bus is shorted or otherwise held low for more than 250 micro
    bool reset(void);
    ...
    void write(uint8_t v, bool power);
